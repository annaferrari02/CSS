...
if __name__ == "__main__":
    ...
    analyzer = BERTopicIntimacyAnalysis(
        topic_info_path="output\\topic_info.csv",
        user_topics_path="output\\user_top10_topics.csv", 
        bot_topics_path="output\\bot_top10_topics.csv",
        model_path="output\\topic_model"  # Se disponibile
    )
