...
1. **annotator_2_template.xlsx** ← QUESTO È IL FILE DA COMPILARE
...
Apri `annotator_2_template.xlsx` con Excel o Google Sheets
...
c) Il campo **annotator_id** è già compilato con "annotator_2"
...
- Quando finisci, salva come: `annotator_2_COMPLETED.xlsx`
...
- [ ] annotator_id è "annotator_2" per tutte le righe
- [ ] File salvato come `annotator_2_COMPLETED.xlsx`
