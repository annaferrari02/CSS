...
1. **annotator_1_template.xlsx** ← QUESTO È IL FILE DA COMPILARE
...
Apri `annotator_1_template.xlsx` con Excel o Google Sheets
...
c) Il campo **annotator_id** è già compilato con "annotator_1"
...
- Quando finisci, salva come: `annotator_1_COMPLETED.xlsx`
...
- [ ] annotator_id è "annotator_1" per tutte le righe
- [ ] File salvato come `annotator_1_COMPLETED.xlsx`
